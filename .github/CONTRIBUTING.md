...
Here we have a set of instructions and guidelines to reduce misunderstandings and make the process of contributing to `Grao Derdu` as smooth as possible.
...
As a user of `Grão Derdu`, you're the perfect candidate to help us improve our documentation!
...
The [`question`](https://github.com/castilhos/grao-derdu/labels/question) label are a
...
- [`bug` issues](https://github.com/castilhos/grao-derdu/labels/bug)
  are known bugs we'd like to fix;
- [`enhancement` issues](https://github.com/castilhos/grao-derdu/labels/enhancement)
  are features we're open to include.

The
[`help wanted`](https://github.com/castilhos/grao-derdu/labels/help%20wanted)
and
[`good first issue`](https://github.com/castilhos/grao-derdu/labels/good%20first%20issue)
